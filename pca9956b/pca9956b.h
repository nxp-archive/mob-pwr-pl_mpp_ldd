...
enum
{
    ...
    PCA9956B_LEDOUT4,
    PCA9956B_LEDOUT5,
    PCA9956B_GRPPWM,        /* DMBLINK set 0, then GRPPWM controls global brightness */
    PCA9956B_GRPFREQ,       /* DMBLINK set 1, then GRPFREQ controls global blinking period */
    ...
    PCA9956B_SUBADR2,
    PCA9956B_SUBADR3,
    PCA9956B_ALLCALLADR,    /* Allows all the PCA9956Bs on the bus to be programmed at the same time */
